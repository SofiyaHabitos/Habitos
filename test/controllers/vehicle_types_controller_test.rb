...
class VehicleTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vehicle_type" do
    assert_difference('VehicleType.count') do
      post vehicle_types_url, params: { vehicle_type: { status: @vehicle_type.status, transport_type: @vehicle_type.transport_type, type_details: @vehicle_type.type_details, vehicle_type_name: @vehicle_type.vehicle_type_name } }
    end
  ...
  test "should update vehicle_type" do
    patch vehicle_type_url(@vehicle_type), params: { vehicle_type: { status: @vehicle_type.status, transport_type: @vehicle_type.transport_type, type_details: @vehicle_type.type_details, vehicle_type_name: @vehicle_type.vehicle_type_name } }
