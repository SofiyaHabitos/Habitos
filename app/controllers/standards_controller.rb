class StandardsController < ApplicationController
  ...
  def new
    ...
    @tenants=Tenant.select { |e| e.site_category.name.downcase == "school" }
  end
  ...
  def create
    ...
    respond_to do |format|
      unless Standard.where(tenant_id:params["standard"]["tenant_id"],standard:params["standard"]["standard"]).present?
         @standard.save
  ...
  private
    ...
    def standard_params
      params.require(:standard).permit(:standard, :tenant_id)
    end
end
